...
def create_report(
    ...
    involved_department: str = Form(""),
    involved_location: str = Form(""),
    involved_role: str = Form(""),
    ...
    report = Report(
        ...
        involved_department=involved_department.strip() or None,
        involved_location=involved_location.strip() or None,
        involved_role=involved_role.strip() or None,
        status="recebida",
        version=1,
    )
